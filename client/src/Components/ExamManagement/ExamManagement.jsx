...
import { fetchExams } from "../../redux/Action/ExamAction";
import "./ExamManagement.css";
import { fetchExamOfClass, selectTests } from "../../redux/Reducer/ExamSlice";

const ExamManagement = ({ classId }) => {
    ...
    useEffect(() => {
        ...
        // if (classId) {
            dispatch(fetchExamOfClass("7740ca00-4810-490f-9971-f11205500e85"));
        // }
    }, []); 
    ...
    const filteredExams = exams.filter((exam) => {
        const matchesType = selectedType === "" || exam.testName.includes(selectedType);
        const matchesSearch =
            searchTerm === "" ||
                ...
                <table className="table">
                    ...
                    <tbody className="tbody">
                        {filteredExams.length > 0 ? (
                            ...
                            <tr>
                                <td colSpan="5" className="td text-center">No exams found</td>
                            </tr>
                        )}
                    </tbody>
                </table>
