...
const ExamManagement = () =>{
    const examData = [
        { code: '00080423', name: 'LẬP TRÌNH NÂNG CAO - GIỮA KỲ 1', date: '08/08/2024', startTime: '08:00', endTime: '08:00' },
        { code: '00081023', name: 'LẬP TRÌNH NÂNG CAO - GIỮA KỲ 1', date: '', startTime: '', endTime: '' },
        { code: '00087823', name: 'LẬP TRÌNH NÂNG CAO - GIỮA KỲ 1', date: '', startTime: '', endTime: '' },
        { code: '00087823', name: 'LẬP TRÌNH NÂNG CAO - GIỮA KỲ 1', date: '', startTime: '', endTime: '' },
        { code: '00087823', name: 'LẬP TRÌNH NÂNG CAO - GIỮA KỲ 1', date: '', startTime: '', endTime: '' },
        { code: '00087823', name: 'LẬP TRÌNH NÂNG CAO - GIỮA KỲ 1', date: '', startTime: '', endTime: '' },
        { code: '00087823', name: 'LẬP TRÌNH NÂNG CAO - GIỮA KỲ 1', date: '', startTime: '', endTime: '' },
