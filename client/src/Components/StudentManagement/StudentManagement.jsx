            ...
            <div className="flex-1">
                ...
                {modal && (
                    <div className="modal">
                        ...
                        <div class="relative p-4 w-full max-w-3xl max-h-full modal-content">
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 md:p-5 text-center">
                                    ...
                                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Choose file you want to import</h3>
